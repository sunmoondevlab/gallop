...
class TranslateEncodingToUtf32Test : public ::testing::Test {};
TEST(TranslateEncodingToUtf32Test, InvalidTextEncoding) {
  std::vector<char> buf{
  ...
  uis = TranslateEncodingToUtf32::translate(
      EncodingCharsetEnum::InvalidTextEncoding, buf);
  ASSERT_EQ(uis.data().size(), (size_t)0);
};
TEST(TranslateEncodingToUtf32Test, FromUtf8) {
  std::vector<char> buf;
  Utf32InputStream uis;
  ...
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF8_BOM, buf);
  uisdata = uis.data();
  ...
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF8, buf);
  uisdata = uis.data();
  ASSERT_EQ(uisdata.size(), (size_t)34);
  ASSERT_EQ(uisdata, expectUisData);
};
TEST(TranslateEncodingToUtf32Test, FromUtf16BE) {
  std::vector<char> buf;
  Utf32InputStream uis;
  std::vector<int32_t> uisdata;
  std::vector<int32_t> expectUisData;
  ...
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF16BE_BOM,
                                            buf);
  uisdata = uis.data();
  ...
  buf = baos.data();
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF16BE, buf);
  uisdata = uis.data();
  ASSERT_EQ(uisdata.size(), (size_t)29);
  ASSERT_EQ(uisdata, expectUisData);
};

TEST(TranslateEncodingToUtf32Test, FromUtf16LE) {
  std::vector<char> buf;
  Utf32InputStream uis;
  std::vector<int32_t> uisdata;
  std::vector<int32_t> expectUisData;
  ...
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF16LE_BOM,
                                            buf);
  uisdata = uis.data();
  ASSERT_EQ(uisdata.size(), (size_t)1);
  ASSERT_EQ(uisdata, expectUisData);
  ...
  expectUisData = std::vector<int32_t>{
      ...
      static_cast<int32_t>(0x0000304a)};
  buf = baos.data();
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF16LE, buf);
  uisdata = uis.data();
  ASSERT_EQ(uisdata.size(), (size_t)29);
  ASSERT_EQ(uisdata, expectUisData);
};
TEST(TranslateEncodingToUtf32Test, FromUtf32BE) {
  std::vector<char> buf;
  Utf32InputStream uis;
  std::vector<int32_t> uisdata;
  std::vector<int32_t> expectUisData;
  ...
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF32BE_BOM,
                                            buf);
  uisdata = uis.data();
  ASSERT_EQ(uisdata.size(), (size_t)1);
  ASSERT_EQ(uisdata, expectUisData);
  ...
  expectUisData = std::vector<int32_t>{
      ...
      static_cast<int32_t>(0x0000304a)};
  buf = baos.data();
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF32BE, buf);
  uisdata = uis.data();
  ASSERT_EQ(uisdata.size(), (size_t)29);
  ASSERT_EQ(uisdata, expectUisData);
};
TEST(TranslateEncodingToUtf32Test, FromUtf32LE) {
  std::vector<char> buf;
  Utf32InputStream uis;
  std::vector<int32_t> uisdata;
  std::vector<int32_t> expectUisData;
  ...
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF32LE_BOM,
                                            buf);
  uisdata = uis.data();
  ASSERT_EQ(uisdata.size(), (size_t)1);
  ASSERT_EQ(uisdata, expectUisData);
  ...
  expectUisData = std::vector<int32_t>{
      ...
      static_cast<int32_t>(0x0000304a)};
  buf = baos.data();
  uis = TranslateEncodingToUtf32::translate(EncodingCharsetEnum::UTF32LE, buf);
  uisdata = uis.data();
  ASSERT_EQ(uisdata.size(), (size_t)29);
  ASSERT_EQ(uisdata, expectUisData);
};
