...
TEST(Utf16StringTest, StringTypes) {
  // null string
  ASSERT_EQ(Utf16::isNullString(u""), true);
  ASSERT_EQ(Utf16::isNullString(u"a"), false);
  // BE
  ...
  ASSERT_EQ(Utf16::isValidString(std::vector<int16_t>{
            ...
            true);
  ASSERT_EQ(
      Utf16::isValidString(u" 0Aa~\xc2\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお"),
      true);
  // LE BOM
  ...
  ASSERT_EQ(Utf16::isValidString(
            ...
            true);
  // ascii
  ASSERT_EQ(Utf16::isAsciiString(std::vector<int16_t>{
                static_cast<int16_t>(0x0001),
                static_cast<int16_t>(0x0001),
                static_cast<int16_t>(0x007e),
            }),
            true);
  ASSERT_EQ(Utf16::isAsciiString(u" 0Aa~"), true);
  ASSERT_EQ(Utf16::isAsciiString(std::vector<int16_t>{
                static_cast<int16_t>(0x0001),
                static_cast<int16_t>(0x007e),
  ...
  ASSERT_EQ(Utf16::isAsciiString(
            ...
            false);
  ASSERT_EQ(
      Utf16::isAsciiString(u" 0Aa~\xc2\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお"),
      false);
};
TEST(Utf16StringTest, ToU8Data) {
  std::vector<char> expectUtf8;
  expectUtf8 = {static_cast<char>(0xef), static_cast<char>(0xbb),
                static_cast<char>(0xbf)};
  // BE BOM
  ASSERT_EQ(Utf16::toU8Data(u"", true), expectUtf8);
  ASSERT_EQ(Utf16::toU8Data(std::vector<int16_t>{static_cast<int16_t>(0xfeff)},
                            false, true),
            expectUtf8);
  // LE BOM
  ASSERT_EQ(Utf16::toU8Data(std::vector<int16_t>{static_cast<int16_t>(0xfffe)},
                            true, true),
            expectUtf8);
  // // without bom
  expectUtf8 = {};
  ...
  ASSERT_EQ(Utf16::toU8Data(std::vector<int16_t>{
                static_cast<int16_t>(0x0020), static_cast<int16_t>(0x0030),
                static_cast<int16_t>(0x0041), static_cast<int16_t>(0x0061),
                static_cast<int16_t>(0x007e), static_cast<int16_t>(0x0080),
                static_cast<int16_t>(0x00a0), static_cast<int16_t>(0x00ff),
  ...
  ASSERT_EQ(Utf16::toU8Data(u" 0Aa~\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお"),
            expectUtf8);
  expectUtf8 = {
...
TEST(Utf16StringTest, ToU16Data) {
  // BE BOM
  ASSERT_EQ(Utf16::toU16Data(std::vector<int16_t>{static_cast<int16_t>(0xfeff)},
                             false, true),
            std::vector<int16_t>{static_cast<int16_t>(0xfeff)});
  ASSERT_EQ(Utf16::toU16Data(u"", false, true),
            std::vector<int16_t>{static_cast<int16_t>(0xfeff)});
  // LE BOM
  ASSERT_EQ(Utf16::toU16Data(std::vector<int16_t>{static_cast<int16_t>(0xfffe)},
                             true, true),
  ...
  ASSERT_EQ(Utf16::toU16Data(std::vector<int16_t>{static_cast<int16_t>(0xfeff)},
                             false, true, true),
            std::vector<int16_t>{static_cast<int16_t>(0xfffe)});
  ASSERT_EQ(Utf16::toU16Data(u"", true, true),
            std::vector<int16_t>{static_cast<int16_t>(0xfffe)});
  // LE BOM to BE BOM
  ASSERT_EQ(Utf16::toU16Data(std::vector<int16_t>{static_cast<int16_t>(0xfffe)},
                             true, false, true),
  ...
  // // without bom
  // BE BOM
  ASSERT_EQ(Utf16::toU16Data(std::vector<int16_t>{
                static_cast<int16_t>(0xfeff), static_cast<int16_t>(0xfeff)}),
            std::vector<int16_t>());
  // LE BOM
  ASSERT_EQ(Utf16::toU16Data(std::vector<int16_t>{static_cast<int16_t>(0xfffe),
                                                  static_cast<int16_t>(0xfffe)},
  ...
  ASSERT_EQ(Utf16::toU16Data(std::vector<int16_t>{
                static_cast<int16_t>(0xdc00), static_cast<int16_t>(0xd800)}),
            expectUtf16);
  ...
  expectUtf16 = {static_cast<int16_t>(0x0020), static_cast<int16_t>(0x0030),
                 ...
                 static_cast<int16_t>(0x3044), static_cast<int16_t>(0x3046),
                 static_cast<int16_t>(0x3048), static_cast<int16_t>(0x304a)};
  ASSERT_EQ(Utf16::toU16Data(u" 0Aa~\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお"),
            expectUtf16);
  ...
  ASSERT_EQ(Utf16::toU16Data(std::vector<int16_t>{static_cast<int16_t>(0x00dc),
                                                  static_cast<int16_t>(0x00d8)},
                             true),
            expectUtf16);
  expectUtf16 = {static_cast<int16_t>(0xfdff), static_cast<int16_t>(0xfdff),
  ...
  // BE surrrogate to LE
  expectUtf16 = {static_cast<int16_t>(0xfdff), static_cast<int16_t>(0xfdff)};
  ASSERT_EQ(Utf16::toU16Data(std::vector<int16_t>{static_cast<int16_t>(0xdc00),
                                                  static_cast<int16_t>(0xd800)},
                             false, true, false),
            expectUtf16);
  expectUtf16 = {static_cast<int16_t>(0xfdff), static_cast<int16_t>(0xfdff),
  ...
  expectUtf16 = {static_cast<int16_t>(0x2000), static_cast<int16_t>(0x3000),
                 ...
                 static_cast<int16_t>(0x4430), static_cast<int16_t>(0x4630),
                 static_cast<int16_t>(0x4830), static_cast<int16_t>(0x4a30)};
  ASSERT_EQ(Utf16::toU16Data(u" 0Aa~\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお", true,
                             false),
            expectUtf16);
  expectUtf16 = {static_cast<int16_t>(0x0020), static_cast<int16_t>(0x0030),
                 static_cast<int16_t>(0x0041), static_cast<int16_t>(0x0061),
...
TEST(Utf16StringTest, ToU32Data) {
  // BE BOM
  ASSERT_EQ(Utf16::toU32Data(std::vector<int16_t>{static_cast<int16_t>(0xfeff)},
                             false, true),
            std::vector<int32_t>{static_cast<int32_t>(0x0000feff)});
  ASSERT_EQ(Utf16::toU32Data(u"", true),
            std::vector<int32_t>{static_cast<int32_t>(0x0000feff)});
  // LE BOM
  ASSERT_EQ(Utf16::toU32Data(std::vector<int16_t>{static_cast<int16_t>(0xfffe)},
                             true, true),
  ...
  ASSERT_EQ(Utf16::toU32Data(std::vector<int16_t>{static_cast<int16_t>(0xfeff)},
                             false, true, true),
            std::vector<int32_t>{static_cast<int32_t>(0xfffe0000)});
  ASSERT_EQ(Utf16::toU32Data(u"", true, true),
            std::vector<int32_t>{static_cast<int32_t>(0xfffe0000)});
  // LE BOM to BE BOM
  ASSERT_EQ(Utf16::toU32Data(std::vector<int16_t>{static_cast<int16_t>(0xfffe)},
                             true, false, true),
  ...
  ASSERT_EQ(Utf16::toU32Data(std::vector<int16_t>{
                static_cast<int16_t>(0xdc00), static_cast<int16_t>(0xd800)}),
            expectUtf32);
  ...
  expectUtf32 = {
      ...
      static_cast<int32_t>(0x00003046), static_cast<int32_t>(0x00003048),
      static_cast<int32_t>(0x0000304a)};
  ASSERT_EQ(Utf16::toU32Data(u" 0Aa~\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお"),
            expectUtf32);
  expectUtf32 = {
  ...
  ASSERT_EQ(Utf16::toU32Data(std::vector<int16_t>{static_cast<int16_t>(0x00dc),
                                                  static_cast<int16_t>(0x00d8)},
                             true),
            expectUtf32);
  expectUtf32 = {static_cast<int32_t>(0xfdff0000),
  ...
  expectUtf32 = {static_cast<int32_t>(0xfdff0000),
                 static_cast<int32_t>(0xfdff0000)};
  ASSERT_EQ(Utf16::toU32Data(std::vector<int16_t>{static_cast<int16_t>(0xdc00),
                                                  static_cast<int16_t>(0xd800)},
                             false, true, false),
            expectUtf32);
  expectUtf32 = {static_cast<int32_t>(0xfdff0000),
  ...
  expectUtf32 = {
      ...
      static_cast<int32_t>(0x46300000), static_cast<int32_t>(0x48300000),
      static_cast<int32_t>(0x4a300000)};
  ASSERT_EQ(Utf16::toU32Data(u" 0Aa~\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお", true,
                             false),
            expectUtf32);
  expectUtf32 = {
      static_cast<int32_t>(0x00200000), static_cast<int32_t>(0x00300000),
...
TEST(Utf16StringTest, ToU8String) {
  // BE BOM
  ASSERT_EQ(
      Utf16::toU8String(std::vector<int16_t>{static_cast<int16_t>(0xfeff)}),
      "");
  // LE BOM
  ASSERT_EQ(Utf16::toU8String(
                std::vector<int16_t>{static_cast<int16_t>(0xfffe)}, true),
            "");
  ASSERT_EQ(Utf16::toU8String(std::vector<int16_t>{
                static_cast<int16_t>(0xfeff),
                static_cast<int16_t>(0xfeff),
            }),
            "");
  ...
  ASSERT_EQ(
      Utf16::toU8String(std::vector<int16_t>{
          static_cast<int16_t>(0x2000), static_cast<int16_t>(0x3000),
          static_cast<int16_t>(0x4100), static_cast<int16_t>(0x6100),
          static_cast<int16_t>(0x7e00), static_cast<int16_t>(0x8000),
          static_cast<int16_t>(0xa000), static_cast<int16_t>(0xff00),
  ...
  ASSERT_EQ(
      ...
      "䠰"
      "䨰");
  ASSERT_EQ(Utf16::toU8String(u" 0Aa~"
                              "\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお"),
            " 0Aa~\xc2\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお");
};
TEST(Utf16StringTest, ToU16String) {
  // BE BOM
  ASSERT_EQ(
      Utf16::toU16String(std::vector<int16_t>{static_cast<int16_t>(0xfeff)}),
      u"");
  // LE BOM
  ASSERT_EQ(Utf16::toU16String(
                std::vector<int16_t>{static_cast<int16_t>(0xfffe)}, true),
            u"");
  ASSERT_EQ(Utf16::toU16String(std::vector<int16_t>{
                static_cast<int16_t>(0xfeff),
                static_cast<int16_t>(0xfeff),
            }),
            u"");
  ...
  ASSERT_EQ(Utf16::toU16String(std::vector<int16_t>{
                ...
                static_cast<int16_t>(0x3044), static_cast<int16_t>(0x3046),
                static_cast<int16_t>(0x3048), static_cast<int16_t>(0x304a)}),
            u" 0Aa~\x80 ÿĀ߿ࠀ��鿿ꀀퟻ豈��𐃺𠀀鼻𰻝𱁬あいうえお");
  ASSERT_EQ(Utf16::toU16String(std::vector<int16_t>{
                static_cast<int16_t>(0x2000), static_cast<int16_t>(0x3000),
                static_cast<int16_t>(0x4100), static_cast<int16_t>(0x6100),
                static_cast<int16_t>(0x7e00), static_cast<int16_t>(0x8000),
  ...
  ASSERT_EQ(Utf16::toU16String(
            ...
            u"ﯗùÜØØ﫜䃘Ü绘᳞菘�蓘泜䈰䐰"
            u"䘰䠰䨰");
  ASSERT_EQ(Utf16::toU16String(u" 0Aa~"
                               u"\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお"),
            u" 0Aa~\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお");
};
TEST(Utf16StringTest, ToU32String) {
  // BE BOM
  ASSERT_EQ(
      Utf16::toU32String(std::vector<int16_t>{static_cast<int16_t>(0xfeff)}),
      U"");
  // LE BOM
  ASSERT_EQ(Utf16::toU32String(
                std::vector<int16_t>{static_cast<int16_t>(0xfffe)}, true),
            U"");
  ASSERT_EQ(Utf16::toU32String(std::vector<int16_t>{
                static_cast<int16_t>(0xfeff),
                static_cast<int16_t>(0xfeff),
            }),
            U"");
  ...
  ASSERT_EQ(Utf16::toU32String(
            ...
            U"ﯗùÜØØ﫜䃘Ü绘᳞菘�蓘泜䈰䐰"
            U"䘰䠰䨰");
  ASSERT_EQ(Utf16::toU32String(u" 0Aa~"
                               u"\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお"),
            U" 0Aa~\x80 ÿĀ߿ࠀ鿿ꀀퟻ豈𐃺𠀀鼻𰻝𱁬あいうえお");
};
