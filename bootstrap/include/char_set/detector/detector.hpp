...
#ifndef _CHAR_SET_DETECTER_
#define _CHAR_SET_DETECTER_
...
private:
  ...
  void scanningBuffer();
  void detectEcsUtfBom(Utf8InputStream &u8is, Utf32InputStream &u32is,
                       Utf16InputStream &u16is);
  void detectEcsUtf8(Utf8InputStream &uis);
