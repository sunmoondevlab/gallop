...
private:
  ...
  Location computeLocation(const size_t &pos, const size_t &tokenSize,
                           const Location location);
  void pushToken(const size_t &pos, const size_t &tokenSize,
  ...
  size_t scanningCharactersLiteral(const size_t &pos);
