...
#ifndef _COMPILER_PARSER_AST_NODE_RETURN_STATEMENT_
#define _COMPILER_PARSER_AST_NODE_RETURN_STATEMENT_
...
public:
  AstNodeReturnStatement(const Location location);
  AstNodeReturnStatement(const AstNodeReturnStatement &rhs);
  ~AstNodeReturnStatement() {};
  AstNodeReturnStatement &operator=(const AstNodeReturnStatement &rhs);
