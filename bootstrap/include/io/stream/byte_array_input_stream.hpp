...
private:
  ...
  // mask
  static constexpr uint16_t MaskByte2Low2Byte = 0xffff;
  static constexpr uint16_t MaskByte2Low1Byte = 0x00ff;
  static constexpr uint32_t MaskByte3Low3Byte = 0x00ffffff;
  static constexpr uint32_t MaskByteLow1Byte = 0x000000ff;
  // shift
