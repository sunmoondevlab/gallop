...
// }; bool AstNodeModuleInterpreter::hasPrev() const { return false; }; bool
// AstNodeModuleInterpreter::hasNext() const { return false; }; bool
// AstNodeModuleInterpreter::hasChild() const { return child != nullptr; };
