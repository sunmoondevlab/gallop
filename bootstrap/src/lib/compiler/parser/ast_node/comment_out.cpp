...
//       endLocation(rhs.endLocation), nodeType(rhs.nodeType),
...
// void AstNodeCommentOut::printNode(const size_t &depth_, const bool
// &isVerbose_)
// {
//   indentDepth(depth_, true);
//   llvm::outs() << getAstNodeTypeString() << "\n";
//   if (isVerbose_) {
//     if (nodeType == AstNodeTypeEnum::coString ||
//         nodeType == AstNodeTypeEnum::coStringDoc) {
