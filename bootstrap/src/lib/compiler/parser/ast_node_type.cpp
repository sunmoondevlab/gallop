...
//     {AstNodeTypeEnum::ltExponentPart,
...
//     {AstNodeTypeEnum::ltHexadecimalPrefix,
...
//     {AstNodeTypeEnum::ltHexadecimalIntegralPart, "hexadecimal number
//     literal"}, {AstNodeTypeEnum::ltSingleCharacter, "single character
//     literal"}, {AstNodeTypeEnum::ltString, "string literal"},
...
//     {AstNodeTypeEnum::scNegativeDecimalNumber,
...
//     {AstNodeTypeEnum::scLogicalAndAssign,
//     "operator(&&=)"}, {AstNodeTypeEnum::scBitOr,
//     "operator(|)"}, {AstNodeTypeEnum::scBitOrAssign,
//     "operator(|=)"}, {AstNodeTypeEnum::scLogicalOr,
//     "operator(||)"}, {AstNodeTypeEnum::scLogicalOrAssign,
//     "operator(||=)"}, {AstNodeTypeEnum::scBitExOr, "operator(^)"},
...
//     {AstNodeTypeEnum::scBitShiftLeftSaturatingAssign,
//     "operator(<<|=)"}, {AstNodeTypeEnum::scGreaterThan,
//     "operator(>)"}, {AstNodeTypeEnum::scGreaterThanEqual,
//     "operator(>=)"}, {AstNodeTypeEnum::scArithmeticBitShiftRight,
//     "operator(>>)"}, {AstNodeTypeEnum::scArithmeticBitShiftRightAssign,
//     "operator(>>=)"},
//     //  : other symbols
...
//     {AstNodeTypeEnum::scDoubleQuotation,
...
//     {AstNodeTypeEnum::scParenthesesClose, "parenthese
//     close')'"}, {AstNodeTypeEnum::scCurlyBracketOpen,
//      "curly bracket open'{'"},
//     {AstNodeTypeEnum::scCurlyBracketClose,
//      "curly bracket close'}'"},
//     {AstNodeTypeEnum::scSquareBracketOpen,
//      "square bracket open'['"},
//     {AstNodeTypeEnum::scSquareBracketClose,
//      "square bracket close'['"},
//     //  : comment out
//     {AstNodeTypeEnum::scOnelineCommentOut,
//      "comment out(oneline) open\"//\""},
//     {AstNodeTypeEnum::scBlockCommentOutOpen,
